      ...
      <div className="py-5 px-10 border-b-1 border-b-[#93595b]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col gap-10">
            <h1 className={`text-5xl cormorant-font font-bold transition-opacity duration-800 ${first ? "opacity-100" : "opacity-0"}`}>Skills</h1>
            <div className="gap-5 flex flex-col max-w-5xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${second ? "opacity-100" : "opacity-0"}`}>
                ...
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${third ? "opacity-100" : "opacity-0"}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 128 128">
                ...
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${fourth ? "opacity-100" : "opacity-0"}`}>
                ...
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${fifth ? "opacity-100" : "opacity-0"}`}>
                ...
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${sixth ? "opacity-100" : "opacity-0"}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 128 128">
                ...
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${seventh ? "opacity-100" : "opacity-0"}`}>
                ...
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${eigth ? "opacity-100" : "opacity-0"}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 128 128">
                ...
                <div className={`w-[180px] sm:w-[200px] py-10 gap-5 flex flex-col items-center bg-neutral-800 hover:bg-[#46282a] cursor-pointer rounded-2xl transition-opacity duration-800 ${ninth ? "opacity-100" : "opacity-0"}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 128 128">
